package handler.springframework.springrecipes.bootstrap;

import handler.springframework.springrecipes.domain.*;
import handler.springframework.springrecipes.repositories.CategoryRepository;
import handler.springframework.springrecipes.repositories.RecipeRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        recipeRepository.saveAll(getRecipes()); //some bs integrity voilation value too long for direction
    }
